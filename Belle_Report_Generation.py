...
#    sht[0].range('J'+str(15+i)+':N'+str(15+i)).value = [spu_2016_old, sku_2016_old, sale_cnt_2016_old, sale_amt_2016_old, dscnt_2016_old]
    sht[0].range('C'+str(6+i)+':G'+str(6+i)).value = [spu_2017,sku_2017,sale_cnt_2017,sale_amt_2017,dscnt_2017,gross_profit_2017,sold_out_2017]
    sht[0].range('L'+str(14+i)+':R'+str(14+i)).value = [spu_2016,sku_2016,sale_cnt_2016,sale_amt_2016,dscnt_2016,gross_profit_2016,sold_out_2016]
    i += 1
